...
namespace Neutron {
	...
	void WindowsWindow::Init(const WindowProps& props)
	{
		...
		// Possibly sets m_Data for which window data has the callback function 
		...
		glfwSetWindowSizeCallback(m_Window, [](GLFWwindow* window, int width, int height)
			{
				WindowData& data = *(WindowData*)glfwGetWindowUserPointer(window); // Cast the UserPointer to usable WindowData
				data.Width = width;
				data.Height = height;
